...
from features.build import FEATURE_NAMES, GROUP_FEATURES, GROUPS, MONOTONE, compute_firm_features
...
def _check_loan_type(loan_type: str) -> None:
...
def _score_payload(msme_id: str, overrides: dict[str, float] | None = None,
    ...
    return _assemble_response(msme_id, profile, g, x, eng, loan_type=loan_type)
